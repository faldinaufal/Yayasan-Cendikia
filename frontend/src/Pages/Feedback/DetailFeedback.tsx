...
const DetailFeedback = () => {
  ...
  return (
    ...
    {openPopUp && (<div className='detail fixed top-0 left-0 bottom-0 right-0'>
        <div className='detail-content overflow-auto mt-10 shadow-white shadow-sm w-96 bg-feedback rounded-xl md:w-3/5 mx-auto'>
            <div className='mt-3 cursor-pointer'>
                <AiOutlineClose className='ml-auto mr-2 text-white text-20' onClick={closePopUp}/>
            </div>
