                ...
                <div className='mx-0 md:mx-7 lg:mx-auto'>
                    <div className='w-[348px] flex flex-col items-center sm:block'>
                        ...
                        <div>
                            ...
                            <button onClick={Login} className='mt-10 w-full mb-10 hover:bg-[#009FCC] duration-200 hover:text-white bg-gray1 rounded-md font-inter font-600 text-gray2 py-3'>Masuk</button>
                        </div>
