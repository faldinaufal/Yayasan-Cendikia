      ...
      <div className='container mb-20'>
        ...
        <div className='flex items-center justify-between mt-10 mb-6'>
          ...
          <div className='flex justify-end'>
            <Link to='/educenter/articles' className='flex items-center font-inter text-[#009FCC] font-600 duration-150 hover:opacity-70'>
              More
        ...
        <div className='mt-20 mb-6 flex items-center justify-between'>
          ...
          <div className='my-1 flex justify-end mr-3'>
            <Link to='/educenter/events' className='flex items-center font-inter text-[#009FCC] font-600 duration-150 hover:opacity-70'>
              More
              <AiOutlineRight className='ml-0.5'/>
            </Link>
          </div>
        ...
        <div className='mt-20 mb-6 flex items-center justify-between'>
          ...
          <div className='my-1 flex justify-end mr-3'>
            <Link to='/educenter/stories' className='flex items-center font-inter text-[#009FCC] font-600 duration-150 hover:opacity-70'>
              More
              <AiOutlineRight className='ml-0.5'/>
            </Link>
          </div>
