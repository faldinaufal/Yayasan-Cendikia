  ...
  return (
    <section className='w-full bg-white'>
      <div className='container pb-14'>
        <div className='flex items-center font-inter font-600 mt-5'>
          <p className='text-[#009FCC] mr-3'>Pusat Edukasi</p>
          <FaChevronRight className='text-[#9CA3AF] mr-3'/>
          <p className='text-[#009FCC] mr-3'>Artikel Ilmiah</p>
          <FaChevronRight className='text-[#9CA3AF] mr-3'/>
          <p className='text-[#6B7280]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
        </div>
        <p className='font-century font-700 text-5xl text-[#262626] mt-4 mb-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
        <div className='flex items-center text-[#6B7280] font-inter font-400'>
          <FaCalendarAlt className='mr-1 text-[#1A1A1A]'/>
          <p className='mr-3'>31 January 2030</p>
          <AiFillEye className='mr-1'/>
          <p>1234x dibaca</p>
        </div>
        <img src={artikel1} alt={artikel1} className='w-[1200px] h-[600px] rounded-2xl my-7'/>
        <p className='font-inter text-[18px] leading-7 text-[#262626]'>
        ...
        <div className='w-full border-[1px] bg-[#9CA3AF] my-5'></div>
        <div className='flex items-center'>
          <p className='font-inter mr-3'>Bagikan</p>
        ...
        <div>
          <p className='font-century font-700 text-4xl text-[#262626] mt-6 mb-2'>Lihat Juga</p>
          <div className='flex flex-wrap justify-center'>
            <div className='w-[384px] shadow-md rounded-md shadow-black/40 mb-5 mr-3'>
              <div>
                <img src={artikel1} alt={artikel1} className='w-[384px] h-[240px] rounded-t-md'/>
              </div>
              <div className='w-[352px] mx-auto'>
                <Link to=''>
                  <p className='font-century font-700 text-2xl text-[#262626] my-3 leading-[30px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                </Link>
                <div className='font-inter text-[#6B7280]'>
