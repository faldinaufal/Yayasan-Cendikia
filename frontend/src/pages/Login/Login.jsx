  ...
  return (
    <section>
        <div className='flex items-center justify-center lg:justify-start'>
            <div className='hidden lg:block bg-image-login h-[960px] rounded-br-[40px] rounded-tr-[40px] bg-no-repeat w-[708px]'></div>
            <div className='lg:ml-3 xl:ml-14'>
                <div className='w-[348px]'>
                    ...
                    <form>
                        ...
                        <button className='mt-10 w-full mb-10 bg-gray1 rounded-md font-inter font-600 text-gray2 py-3'>Masuk</button>
                    </form>
                    <div className='font-inter flex items-center justify-center'>
                        <p className='text-dark mr-1'>Belum Pernah Mendaftar?</p>
                        <Link to='' className='font-600 text-[#009FCC] hover:opacity-70 duration-200'>Daftar sekarang</Link>
                    </div>
                ...
                <div className='flex flex-col items-center mb-10'>
                    ...
                    <p className='font-inter text-gray3'>&copy; 2022 Ruang Disabilitas. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </section>
