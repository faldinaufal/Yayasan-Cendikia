            ...
            <div className='font-inter text-base align-middle font-semibold leading-6 gap-6 md:flex md:items-center'>
              ...
              <div className='absolute right-0 hidden md:flex md:items-center'>
                  <a href={`/${process.env.REACT_APP_LOGIN}`}>
                   <button className='w-[146px] h-[48px] bg-[#009FCC] font-inter text-base font-semibold text-white rounded hover:bg-white hover:text-[#009FCC] hover:border-[#009FCC] hover:border-2 flex items-center justify-center'>Masuk / Daftar</button>
                  </a>
              </div>
            </div>
          </div>
