...
import { Home, AboutUs, Education, EducationCenter, EC, MoreArticle, DetailAEC, Join, Login, Register, ForgotPass, EmailSent, EditPass, PassSucc, MoreEvnt, DetailEvnt, MoreStory, DetailStory, MoreThera, MoreConsul } from '../pages';
